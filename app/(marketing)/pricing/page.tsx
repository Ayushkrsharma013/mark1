...
import { ArrowRight, Check, Shield, FileText, RotateCcw, Truck, Ban, CreditCard } from "lucide-react";

export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Transparent pricing for AI automation services — custom-built solutions starting at ₹3,000. No hidden fees.",
};
      ...
      <div className="relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.04)] bg-[rgba(255,255,255,0.01)] p-8 md:p-12 mb-10">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-sm text-[#71717a] mt-2 max-w-lg mx-auto">
            Custom AI automation — scoped to your business, priced for your scale. No templates. No hidden fees.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          {tiers.map((tier) => (
            ...
            >
              ...
              <p className="mt-3 text-sm text-[#a1a1aa] leading-relaxed">{tier.description}</p>
